...
function petSleep(pet){
	$('.show-interact').append(`<center><input type="submit" id="sleep-button" value="Sleep"/></center>`)
...
function petPlay(pet){
	...
	if (pet.toys[i].id === 1){
		$('.show-interact').append(`<center><input type="submit" id="rubiks-cube-button" value="Play Rubik's Cube"/></center>`)
		...
		$('.show-interact').append(`<center><input type="submit" id="jump-rope-button" value="Play Jump Rope"/></center>`)
